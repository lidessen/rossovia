globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/SkeletonPreview-BYnO1g7b.js","assets/layout-segment-context-AwoDFFza.js"];
...
function getDraftSecret() {
	return "6cb5e036-82d5-45df-a3ca-47741cd9a2a9";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "9ea5fdb6-752c-4c67-be07-80395e465df9";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "9ea5fdb6-752c-4c67-be07-80395e465df9") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "9ea5fdb6-752c-4c67-be07-80395e465df9",
		rootBoundaryId
	});
}
/**
...
var SkeletonPreview = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'SkeletonPreview' is called on server");
}, "9695a020db4c", "SkeletonPreview");
//#endregion
//#region app/page.tsx
...
var metadata$1 = {
	...
	description: "Your first version will appear here automatically when it’s ready.",
	other: { "codex-preview": "development" }
};
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SkeletonPreview, {});
}
