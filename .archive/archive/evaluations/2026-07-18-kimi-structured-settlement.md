...
The generic [AI SDK driver](../packages/work-cell/src/integrations/ai-sdk/ai-sdk-driver.ts)
removes the schema instruction and response format from the investigation loop,
then calls the internal
[structured settlement](../packages/work-cell/src/integrations/ai-sdk/structured-settlement.ts)
