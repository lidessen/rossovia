...
export async function verifyAgentEraBlogPublicationEffect(input: {
  ...
  return verifyAgentEraBlogEffectWithProfile(input, {
    ...
    verifierSources: [{
      ref:
        "source-project:operations/autonomy/experiments/agent-era-blog-publication-effect-verifier.ts",
      path: fileURLToPath(import.meta.url),
    }, {
      ref:
        "source-project:operations/autonomy/experiments/verify-agent-era-blog-publication-candidate.ts",
      path: fileURLToPath(
        new URL(
