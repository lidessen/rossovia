        ...
        <section class="system-surface" id="observer-surface" aria-labelledby="observer-title" hidden>
          ...
          <div class="observer-overview" aria-label="观察记录状态">
            ...
            <div class="observer-overview-card">
              ...
              <small id="observer-trigger-state">Task/Run 终态结算后触发</small>
            </div>
            <div class="observer-overview-card">
              <span>最近记录</span>
          ...
          <div class="system-surface-note">
            <strong>怎么使用</strong>
            <span>这里展示真实的只读意见。当前 observer 在 Task/Run 终态结算后触发；不会追溯补审旧 Task，也不会把空记录伪装成 review。处理意见仍然是一次普通对话 Task。</span>
          </div>
