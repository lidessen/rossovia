    ...
    <main class="workbench-shell">
      ...
      <section class="project-surface" id="project-surface" aria-labelledby="project-title" tabindex="-1">
        ...
        <section class="worktree-inventory" aria-labelledby="worktree-inventory-heading">
          ...
          <div class="worktree-inventory-summary" id="worktree-inventory-summary" data-standing="unknown">—</div>
          <p class="worktree-inventory-note" id="worktree-inventory-note" data-standing="deferred" role="status">
        ...
        <section class="system-surface" id="observer-surface" aria-labelledby="observer-title" hidden>
          <header class="unified-header system-surface-header">
            <div>
              ...
              <p>这里是 observer 的只读意见面，不是对话入口，也不自动处理任何 review；每条 review 的观察来源按 canonical attempt correlation 显示，缺失时明确不可见。</p>
            </div>
          ...
          <div class="observer-overview" aria-label="观察记录状态">
            <div class="observer-overview-card" data-state="waiting">
              <span>当前状态</span>
              <strong id="observer-record-state">正在读取</strong>
              <small id="observer-record-state-detail">正在确认 observer 是否已触发。</small>
            </div>
            ...
            <div class="observer-overview-card">
              <span>最近记录</span>
              <strong id="observer-last-recorded">—</strong>
              <small id="observer-review-count-summary">0 条意见</small>
            </div>
          </div>
      ...
      <aside class="action-surface" id="work-item-peek" aria-labelledby="action-heading" hidden>
        ...
        <section class="task-create-panel" id="task-create-panel" hidden>
          ...
          <form id="task-create-form">
            ...
            <p class="task-create-worktree-status" id="task-create-worktree-status" data-standing="unknown" hidden></p>
...
.worktree-inventory-summary[data-standing="observed"] {
  color: var(--green-dark);
}

.worktree-inventory-note {
  color: var(--ink-faint);
  font-size: 0.58rem;
  line-height: 1.45;
  margin: 0.25rem 0 0;
...
.worktree-inventory-note[data-standing="loading"],
.worktree-inventory-note[data-standing="unavailable"],
.worktree-inventory-note[data-standing="partial"] {
  color: var(--ochre);
}

.inventory-worktree[data-dirty-standing="dirty"] span {
  color: var(--red);
}

.inventory-worktree[data-dirty-standing="unknown"] span {
  color: var(--ochre);
}

.task-create-worktree-status {
...
.task-create-worktree-status[data-standing="dirty"] {
  border-left-color: var(--red);
  color: var(--red-dark);
}

.task-create-worktree-status[data-standing="clean"] {
  border-left-color: var(--green);
  color: var(--green-dark);
}

.task-create-worktree-status[data-standing="unknown"] {
  border-left-color: var(--ochre);
  color: var(--ochre);
}
...
.observer-overview-card > span,
.observer-overview-card > small {
  color: var(--ink-faint);
  font-size: 0.65rem;
  line-height: 1.45;
}

.observer-overview-card > strong {
  color: var(--ink);
  font-size: 0.9rem;
  overflow-wrap: anywhere;
}

.observer-overview-card[data-state="recorded"] {
  border-left: 3px solid var(--green);
}

.observer-overview-card[data-state="waiting"],
.observer-overview-card[data-state="empty"] {
  border-left: 3px solid var(--ochre);
}

.observer-overview-card[data-state="disabled"],
.observer-overview-card[data-state="unavailable"] {
  border-left: 3px solid var(--red);
}
...
.observer-review-correlation > span {
  color: var(--ink-faint);
  font-family: var(--mono);
  font-size: 0.56rem;
  text-transform: uppercase;
...
.observer-review-correlation code,
.observer-review-correlation small {
  display: block;
  font-size: 0.62rem;
  line-height: 1.45;
  overflow-wrap: anywhere;
...
/* First-screen attention path: latest-record banner, then the actionable /
   observe-only partitions. Pure presentation of the existing group
   projection; no state is added and nothing auto-processes. */
.observer-attention-note {
  color: var(--ink-faint);
  font-size: 0.62rem;
  line-height: 1.5;
  margin: 0;
...
.observer-latest-banner time {
  color: var(--ink-faint);
  font-family: var(--mono);
  font-size: 0.62rem;
}

.observer-latest-summary {
  color: var(--ink);
  font-size: 0.8rem;
  line-height: 1.5;
  margin: 0;
...
.observer-latest-facts > div {
  display: grid;
  gap: 0.4rem;
  grid-template-columns: 64px minmax(0, 1fr);
}

.observer-latest-facts dt {
  color: var(--ink-faint);
  font-family: var(--mono);
  font-size: 0.55rem;
  text-transform: uppercase;
...
.observer-partition-heading span {
  color: var(--ink);
  font-family: var(--mono);
  font-size: 0.72rem;
  font-weight: 650;
...
.observer-partition-heading small {
  color: var(--ink-faint);
  font-size: 0.62rem;
  line-height: 1.45;
  text-align: right;
...
.observer-partition[data-partition="observe-only"] .observer-partition-heading {
  border-bottom-color: var(--line);
}

.observer-partition[data-partition="observe-only"] .observer-partition-heading span {
  color: var(--ink-soft);
}

.observer-partition-list {
  display: grid;
  gap: 0.85rem;
  margin-top: 0.85rem;
}

.observer-review-meta {
  border-top: 1px solid var(--line-light);
  color: var(--ink-soft);
  font-family: var(--mono);
  font-size: 0.6rem;
...
.observer-group-no-process {
  color: var(--ink-faint);
  font-size: 0.62rem;
  line-height: 1.45;
}

.observer-review-correlation small.observer-correlation-unknown {
  color: var(--ink-faint);
}

.observer-review-correlation small.observer-correlation-unknown[data-standing="missing"],
.observer-review-correlation small.observer-correlation-unknown[data-standing="absent"] {
  color: var(--ochre);
}
...
.observer-empty[data-state="recorded"] {
  border-left: 3px solid var(--green);
}

.observer-empty[data-state="waiting"],
.observer-empty[data-state="empty"] {
  border-left: 3px solid var(--ochre);
}

.observer-empty[data-state="disabled"],
.observer-empty[data-state="unavailable"] {
  border-left: 3px solid var(--red);
}

.observer-empty-kicker {
  color: var(--ink-faint);
  font-family: var(--mono);
  font-size: 0.6rem;
  letter-spacing: 0.12em;
...
.observer-empty strong {
  color: var(--ink);
  font-size: 1rem;
}

.observer-empty small {
  color: var(--ink-faint);
  font-size: 0.62rem;
  line-height: 1.5;
  overflow-wrap: anywhere;
...
@media (max-width: 700px) {
  ...
  .masthead .identity > div:last-child {
    min-width: 0;
  }
...
@media (max-width: 700px) {
  ...
  .workbench-shell {
    display: block;
    min-height: calc(100vh - var(--mobile-masthead-height));
  }
  ...
  .conversation-surface {
    background: var(--paper-light);
    height: calc(100dvh - var(--mobile-masthead-height));
    left: 0;
    min-height: 0;
...
.task-triage-note[data-standing="partial"],
.task-triage-note[data-standing="task-source-read"] {
  color: var(--ochre);
}
