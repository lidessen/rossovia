...
3. Restore only the fixture and evidence packets from `<evidence-revision>`:
   ...
   git -C /private/tmp/rossovia-delegation-repro restore \
     ...
     evaluations/evidence/2026-08-06-todo-return-trigger/fixture \
     evaluations/evidence/2026-08-07-host-constructed-nested-topology \
     evaluations/evidence/2026-08-08-parent-evidence-admission \
     evaluations/evidence/2026-08-08-parent-admission-matched-pair
   ```
...
4. Install the pinned Work Cell dependencies, then run the no-model preflights:
   ...
   bun install --cwd=/private/tmp/rossovia-delegation-repro/packages/work-cell \
     --frozen-lockfile
   bun --cwd=/private/tmp/rossovia-delegation-repro/evaluations/evidence/2026-08-07-host-constructed-nested-topology \
     run-topology.ts --preflight
   bun --cwd=/private/tmp/rossovia-delegation-repro/evaluations/evidence/2026-08-08-parent-evidence-admission \
     run-parent-treatment.ts --preflight
   bun --cwd=/private/tmp/rossovia-delegation-repro/evaluations/evidence/2026-08-08-parent-admission-matched-pair \
