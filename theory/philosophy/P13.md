...
**哲学基础：** P13｜主张不等于事实；事实须经可追溯的验证提交｜实践论 / 控制论

> Read P13 in `theory/philosophy.md` first.
...
- Mao's [《实践论》](https://www.marxists.org/reference/archive/mao/selected-works/volume-1/mswv1_16.htm)
  ...
  than declared true.
- The adopted [fact-admission record](https://github.com/lidessen/rossovia/blob/archive/v0.5/principles/adopted/fact-admission-gate.md)
