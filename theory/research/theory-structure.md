...
theory 的 canonical path，根目录旧 path 不存在；`theory/philosophy/P01.md … P16.md`
当前尚未重建，目标 standing 仍是 readings。下文关于 `theory/harness.md` 的“当前/提议”
...
| harness theory | 当前 `theory/harness.md`；提议迁至 `theory/harness/theory.md` | harness theory owner / `theory/`，接受前为 proposal | 任务工程与 Agent 环境的设计理论；可被证据修订 | 不实现 base，不授权效果，不吞并所有 Agent 方法 |
...
├── philosophy/
│   ├── P01.md … P16.md            # readings/解读；不得改 source lines
│   └── draft/                     # 未采纳候选
