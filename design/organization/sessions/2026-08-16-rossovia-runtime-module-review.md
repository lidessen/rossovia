...
| [Structured-settlement retry loop](../../../packages/work-cell/src/integrations/ai-sdk/structured-settlement.ts) | Provider/SDK compatibility adapter | Enable only for a selected adapter that cannot return the declared shape directly; it is not C3 itself |
