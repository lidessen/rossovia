...
| Verify | proposed diff and acceptance | independent verifier | mechanical result plus review observation | failure returns to execution or principal |
...
5. Open a PR into `main`, preserve failed checks and review observations, and
   request the named human disposition. A green check is necessary evidence,
   not acceptance.
